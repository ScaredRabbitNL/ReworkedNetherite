...
public class RNItems {
    ...
    public static final ResourcefulRegistry<Item> BUCKETS = ResourcefulRegistries.create(BuiltInRegistries.ITEM, ReworkedNetherite.MOD_ID);
    ...
    public static final RegistryEntry<Item> MOLTEN_NETHERITE_BUCKET = BUCKETS.register("molten_netherite_bucket",
            () -> new BucketItem(RNLiquids.SOURCE_MOLTEN_NETHERITE.get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
